...
namespace freeform
{
    ...
    inline shader_bezier_vs   create_shader_samples_vs(ID3D11Device* device)
    {
        return shader_bezier_vs(details::create_shader_bezier_vs(device));
    }

    inline std::future< shader_bezier_vs> create_shader_samples_vs_async(ID3D11Device* device)
    {
